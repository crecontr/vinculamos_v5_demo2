<?php
	...
	$id_encuesta_encoded = noeliaEncode($encuesta[0]["id"]);
	...
	<div class="content-wrapper">
    	...
    	<section class="content-header">
      		...
      		<ol class="breadcrumb">
        		...
        		<li class="active">Editar Iniciativa - Consolidado encuesta de satisfacción</li>
      		</ol>
    	</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
	    						<h3 class="box-title"><?php echo ($iniciativa[0]["nombre"] == "" ? "Editar iniciativa" : $iniciativa[0]["nombre"]);?> - Resultados para <?php echo$encuesta[0]["tipo"];?></h3>
							</div>
							<!-- /.box-header -->
...
<script>
	...
	function loadAttendanceSurveyResult() {
		var parametros = {
			...
			"id_survey" : '<?php echo$id_encuesta_encoded;?>'
    };
		$.ajax({
			type: "POST",
      url: "./ajax_view_survey_results.php",
      data:  parametros,
      beforeSend: function () {
