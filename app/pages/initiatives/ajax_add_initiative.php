<?php
	...
	if( isset($_REQUEST['vg_nombre']) && isset($_REQUEST['vg_fecha_inicio']) &&
		isset($_REQUEST['vg_fecha_finalizacion']) && isset($_REQUEST['vg_autor']) ) {

		include_once("../../controller/medoo_initiatives.php");

		$result = addInitiative($_REQUEST['vg_nombre'], $_REQUEST['vg_fecha_inicio'],
			$_REQUEST['vg_fecha_finalizacion'], $institucion, noeliaDecode($_REQUEST['vg_autor']));
