<?php
	...
	if( isset($_REQUEST['vg_initiative']) && isset($_REQUEST['vg_tipo']) && isset($_REQUEST['vg_usuario']) ) {
		...
		$result = addEvaluation(noeliaDecode($_REQUEST['vg_initiative']), $_REQUEST['vg_tipo'], noeliaDecode($_REQUEST['vg_usuario']));
		...
		<?php
			...
			<div class="alert alert-warning alert-dismissible" role="alert">
				...
				La evaluación que intenta agregar ya existe.
			</div>
		<?php
		}

	} else {
		echo "<br> Falta info para crear evaluación";
	}
?>
