<?php
	...
	if( isset($_REQUEST['vg_id']) && isset($_REQUEST['vg_initiative']) && isset($_REQUEST['vg_usuario']) ) {
		...
		include("../../controller/medoo_participation_real.php");
		$result = deleteRealParticipation(noeliaDecode($_REQUEST['vg_id']), noeliaDecode($_REQUEST['vg_initiative']), noeliaDecode($_REQUEST['vg_usuario']));
