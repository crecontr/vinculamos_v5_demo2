<?php
	...
	if( isset($_REQUEST['vg_id']) && isset($_REQUEST['vg_encuesta']) && isset($_REQUEST['vg_usuario']) ) {
		...
		$result = editQuestion(noeliaDecode($_REQUEST['vg_id']), noeliaDecode($_REQUEST['vg_encuesta']),
			$_REQUEST['vg_titulo'], $_REQUEST['vg_tipo_respuesta'], noeliaDecode($_REQUEST['vg_usuario']));
