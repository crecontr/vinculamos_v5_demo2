<!-- Modal -->
<div class="modal fade" id="deleteParticipation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" method="post" id="delete_participation" name="delete_participation">
