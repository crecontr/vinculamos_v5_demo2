<!-- Modal -->
<div class="modal fade" id="addEvaluation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Agregar Evaluación
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_crear"></div>
				<p class="text-center">
					<strong>Se creará la evaluación para el tipo seleccionado.<br>¿Desea continuar?</strong>
				</p>
				<form class="form-horizontal" method="post" id="add_evaluation" name="add_evaluation">
