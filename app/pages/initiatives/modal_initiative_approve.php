<!-- Modal -->
<div class="modal fade" id="approveInitiative" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p class="text-center">
					<strong>Se aprobará esta iniciativa.<br>¿Desea continuar?</strong>
				</p>
				<form class="form-horizontal" method="post" id="approve_initiative" name="approve_initiative">
