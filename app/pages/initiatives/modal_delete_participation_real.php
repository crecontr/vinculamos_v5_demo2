<!-- Modal -->
<div class="modal fade" id="deleteParticipationReal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Eliminar participantes reales
				</h4>
			</div>
			<div class="modal-body">
				...
				<form class="form-horizontal" method="post" id="delete_participation_real" name="delete_participation_real">
