    	...
    	<!-- Content Header (Page header) -->
			<section class="content-header">
      		<h1>
        		...
        		<small>editar unidad institucional</small>
      		</h1>
      		<ol class="breadcrumb">
        		<li><i class="fa fa-dashboard"></i> Inicio</li>
        		<li>Unidades institucionales</li>
				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
    						...
    						<form class="form-horizontal" method="post" id="edit_college" name="edit_college">
								...
								<div class="row">
									...
									<div class="col-md-8">
										...
										<div class="modal-footer">
											<a href="view_colleges.php" class="btn btn-default" data-dismiss="modal">Ir al listado</a>
...
<script>
	...
	$("#edit_college").submit(function( event ) {
		$('#edit_college').attr("disabled", true);
		var parametros = $(this).serialize();
		$.ajax({
			type: "POST",
			url: "./ajax_edit_college.php",
			data: parametros,
