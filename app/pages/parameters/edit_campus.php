				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
    						...
    						<form class="form-horizontal" method="post" id="edit_campus" name="edit_campus">
								...
								<div class="row">
									...
									<div class="col-md-8">
										...
										<div class="modal-footer">
											<a href="view_campus.php" class="btn btn-default" data-dismiss="modal">Ir al listado</a>
...
<script>
	...
	$("#edit_campus").submit(function( event ) {
		$('#edit_campus').attr("disabled", true);
		var parametros = $(this).serialize();
		$.ajax({
			type: "POST",
			url: "./ajax_edit_campus.php",
			data: parametros,
