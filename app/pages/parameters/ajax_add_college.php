<?php
	...
	if( isset($_REQUEST['vg_nombre']) && isset($_REQUEST['vg_descripcion']) && isset($_REQUEST['vg_director']) && isset($_REQUEST['vg_usuario']) ) {
		...
		$result = addCollege($_REQUEST['vg_nombre'], $_REQUEST['vg_descripcion'],
		...
		if($result != null) { ?>
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				Unidad institucional guardada correctamente.
			</div>
		<?php
		} else { ?>
			<div class="alert alert-warning alert-dismissible" role="alert">
				...
				La unidad institucional que intenta agregar ya existe.
			</div>
		<?php
		}
